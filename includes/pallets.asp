  ...
  <div class="ipanel-content">
	  ...
	  <div class="ipanel">
		  ...
		  <div class="ipanel-content">
			...
			<div class="add dragIn" draggable="true" data-type="graphit-node" data-class="glyphicon glyphicon-print" data-caption="printer" data-tooltip="tool tip text"><span class="icon glyphicon glyphicon-print" ></span></div>
